...
public class TrackObject {
     ...
     */
    public TrackObject(String id, Album album, ArtistObject[] artists, int durationMs, boolean explicit, boolean isPlayable, String name, String previewUrl) {
        this.id = id;
        this.album = album;
